...
SECRET_KEY = 'django-insecure-b)vf9am0^=b4p_4q%=9ceam53l28i9yzqy8r9v#*kaxn4qlt0r'
...
# Following configuration is for sending the email using SMTP server, comment EMAIL_BACKEND when using this
